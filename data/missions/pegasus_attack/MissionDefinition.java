package data.missions.pegasus_attack;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "BS");
		api.setFleetTagline(FleetSide.ENEMY, "Cylon fleet");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Defeat all enemy forces");
		api.addBriefingItem("Battlestar Pegasus must survive");
		
		// Set up the player's fleet
		api.addToFleet(FleetSide.PLAYER, "bsg_mercury_variant", FleetMemberType.SHIP, "Pegasus", true);
		
		// Mark player flagship as essential
		api.defeatOnShipLoss("Pegasus");
