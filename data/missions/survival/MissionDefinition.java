package data.missions.survival;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "BS-75 Galactica");
		api.setFleetTagline(FleetSide.ENEMY, "Cylon attack fleet");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("BSG-075 Galactica must survive");
		
		// Set up the player's fleet
		api.addToFleet(FleetSide.PLAYER, "bsg_galactica_variant", FleetMemberType.SHIP, "BS-75 Galactica", true);
		
		// Mark player flagship as essential
		api.defeatOnShipLoss("BSG-075 Galactica");
